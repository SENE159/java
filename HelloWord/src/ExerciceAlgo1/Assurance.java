...
public class Assurance {
	...
	public static void main(String[] args) {
     ...
     System.out.println("Indiquez le nombre d'années que vous étes client de l'agence");
     NACL = clavier.nextInt();
     clavier.nextLine();
     
     if(NACL>=5) {
     System.out.println("Dans le cadre de la fidélisation de la clientèle, votre tarification passe à la gamme supérieur ");
     ...
     if (couleur.equals("vert")) {
    	 System.out.println("Vous passer à la tarification bleu");
    	 
     }else if (couleur.equals("orange")) {
    	 System.out.println("Vous passer à la tarification vert");
     ...
     System.out.println("Entrée votre age?");
     age = clavier.nextInt();
     System.out.println("Entrée le nombre d'année d'obtention de votre permis de conduire?");
     Naop = clavier.nextInt();
     System.out.println("Entrée le nombre d'accidents que vous avez eu?");
     Nac = clavier.nextInt();
